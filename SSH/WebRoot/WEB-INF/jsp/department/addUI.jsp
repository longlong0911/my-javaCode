...
<div id=MainArea>
    ...
    <s:form action="departmentAction_%{id == null ? 'add' : 'update'}" theme="simple">
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr><td width="100">上级部门</td>
                        <td>
                        	<s:select name="parentId" cssClass="SelectStyle" list="#DepartmentTreeList" listKey="id" 
							listValue="name" headerKey="" headerValue="请选择部门"/>	
                        </td>
                    </tr>
                    <tr><td>部门名称</td>
