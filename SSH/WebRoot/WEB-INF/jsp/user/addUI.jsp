...
<div id=MainArea>
    ...
    <s:form action="userAction_%{id == null ? 'add' : 'update'}" theme="simple">
			 <s:hidden name="id"/>
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr>
                        ...
                        <td>
                            <s:select name="departmentId" list="#topDepartmentList" listKey="id" listValue="name" 
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr>
						<td width="100">岗位</td>
                        <td>
                            <s:select name="postIds" list="#posts"
				 			listKey="id" listValue="name" multiple="true" size="8"/>
							按住Ctrl键可以多选或取消选择
                        </td>
                    </tr>
                </table>
